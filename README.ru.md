...
Новости: PatchKit re-anchor'нут на Hermes Agent `v2026.5.16` / `0.14.0`. Старый Grok2API sidecar bridge теперь legacy fallback; для Grok/SuperGrok предпочитаем upstream-native `xai` / `xai-oauth`. См. [NEWS.md](NEWS.md).
