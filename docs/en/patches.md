...
Current release anchor: `manifests/upstream-v2026.6.5.yaml`. The release-specific patch files live under `patches/v2026.6.5/` and are checked against the official `NousResearch/hermes-agent` tag `v2026.6.5` / Hermes Agent `0.16.0`, not post-release `main`.
