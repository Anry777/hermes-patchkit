...
Текущий релизный якорь: `manifests/upstream-v2026.5.16.yaml`. Release-specific patch files лежат в `patches/v2026.5.16/` и проверяются против official tag `v2026.5.16` / Hermes Agent `0.14.0` из `NousResearch/hermes-agent`, а не против post-release `main`.
