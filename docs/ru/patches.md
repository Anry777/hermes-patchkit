...
- Активные `v2026.4.30` patches сейчас: `020`, `030`, `040`, `050`, `061` и optional `080`.
...
|---|---|---|
| `200-dashboard-profile-api` | planned | Read-only profile-aware backend endpoints для dashboard: profiles, summaries, sessions, logs. |
| `201-dashboard-profile-selector` | planned | Profile selector/cards в родном dashboard без изменения global active profile. |
